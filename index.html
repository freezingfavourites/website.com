...
<div class="header-1">
    ...
    <h3 class="call"> <i class="fas fa-phone"></i> call now : +01895447000 </h3>
...
<div class="content">
    <h1>24 Hours <span>Italian</span> Resturant</h1>
    <p>The Home Of Taste In West Drayton<br> Trading Since <br>(April 2020)</p>
...
<div class="icons-container">
    ...
    <div class="icons">
        ...
        <p>Bank In Use: BARCLAYS BANK</p>
    </div>

    <div class="icons">
        <i class="fas fa-headset"></i>
        <h3>Openning Hour</h3>
        <p>(12:30 PM-12:00 AM)</p>
    </div>
...
<form action="ADMINFORM.PHP" method="POST">
    ...
    <div class="inputBox">
        <textarea cols="30" rows="10" placeholder="full address" id="adress"></textarea>
        <iframe id="map" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2483.19050254659!2d-0.4613399847996088!3d51.50972091835529!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x487672065f15fe05%3A0x229210be74471036!2sLiddall%20Way%2C%20West%20Drayton%20UB7%208PG%2C%20UK!5e0!3m2!1sen!2s!4v1629982730751!5m2!1sen!2s" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
    </div>
...
<section class="footer">
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <p> <i class="fas fa-map-marker-alt"></i> Unit 1, Chancerygate Industial Cent,HortonClose, West Drayton <br>UB7 8EW. United Kingdom </p>
            <p> <i class="fas fa-envelope"></i>umairahmed486950@gmail.com </p>
            <p> <i class="fas fa-globe"></i> www.24houritalianresturant.com </p>
        </div>

    </div>

<h1 class="credit"> created by <span>Mr Raja. web developer</span> | all rights reserved! </h1>
